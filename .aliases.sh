...
alias codex-wayve='cd /workspace/WayveCode/ && bazel run //tools:codex -- --cd /workspace/WayveCode/ --add-dir /home/borisindelman/git/vault --add-dir /workspace/WayveCode/ --add-dir /workspace/WayveCode/ /home/borisindelman/.codex --ask-for-approval on-failure --search '
