...
alias codex-wayve='cd /workspace/WayveCode/ && bazel run //tools:codex -- --cd /workspace/WayveCode/ --add-dir /home/borisindelman/git/vault --add-dir /workspace/WayveCode/ --ask-for-approval on-failure --search '
