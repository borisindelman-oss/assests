...
### Change log
- Main log: `~/git/vault/agents-change-log.md`
...
### Todo list
- location: Main log: `~/git/vault/todo-list.md`
...
- Place `newsletter_[topic].md` files under `~/git/vault/newsletters/`.
